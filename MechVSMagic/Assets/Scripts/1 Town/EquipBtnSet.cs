...
public class EquipBtnSet : MonoBehaviour
{
    ...
    public void Init(SmithManager s, List<KeyValuePair<int, Equipment>> p)
    {
        SM = s;
        BM = null;
        int i = 0;
    ...
    public void Init(SmithManager s, List<KeyValuePair<int, EquipBluePrint>> p)
    {
        SM = s;
        BM = null;
        int i = 0;
    ...
    public void Init(SmithManager s, List<KeyValuePair<int, Skillbook>> p)
    {
        SM = s;
        BM = null;
        int i = 0;
    ...
    public void Init(BedManager b, List<KeyValuePair<int, Equipment>> p)
    {
        BM = b;
        SM = null;
        int i = 0;
